...
import { Check, CheckCheck, Clock, Download, File, Image, Trash2, X } from "lucide-react";
    ...
    return (
      <div className={`flex ${isOwn ? "justify-end" : "justify-start"} mb-2`}>
        <div className={`group max-w-[70%] ${isOwn ? "order-2" : "order-1"}`}>
          <div className="rounded-2xl px-3 py-2 bg-base-300/50 text-base-content/50 italic">
  ...
  return (
    <>
      <div className={`flex ${isOwn ? "justify-end" : "justify-start"} mb-2 group`}>
        {/* Delete button with confirmation (only for own messages and not optimistic) */}
