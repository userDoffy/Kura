...
import { Camera, Edit3, MapPin, Globe, Users, Lock, Save, X, Eye, EyeOff, Upload, Mail } from "lucide-react";
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex items-center gap-4 text-center text-sm">
              <div className="flex items-center gap-1">
                ...
                <span className="font-semibold">{authUser?.friends?.length || 0}</span>
                <span className="text-base-content/60 hidden sm:inline">friends</span>
              </div>
              <div className="flex items-center gap-1">
                <Globe className="w-4 h-4 text-primary" />
                <span className="text-base-content/80 text-xs">{formData.language || "Not specified"}</span>
              </div>
              {formData.location && (
                <div className="flex items-center gap-1">
                  <MapPin className="w-4 h-4 text-primary" />
                  <span className="text-base-content/80 text-xs">{formData.location}</span>
                </div>
              )}
            </div>
        ...
        <div className="p-6">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="form-control">
              ...
              <textarea
                className="textarea textarea-bordered w-full h-20 resize-none focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                name="bio"
                value={formData.bio}
                onChange={handleChange}
